...
const Work = () => {
  ...
  return (
    <>
      <h2 className="head-text" style={{ marginTop: 50 }}>My Creative  <span>Portfolio</span> Section </h2>
      <div className="app__Work-filter  ">
        {['Ui Developer', 'freelance work', 'Web App', 'React.Js', 'Angular', 'All'].map((item, index) => (
